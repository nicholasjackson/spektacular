...
A debug mode for the spektacular CLI that provides verbose logging, internal state inspection, and diagnostic output during spec workflows. Currently, developers contributing to spektacular have limited visibility into what the CLI is doing internally, making it difficult to diagnose issues or understand workflow behavior. This benefits spektacular developers and contributors by accelerating debugging and reducing the feedback loop when working on new features or fixing bugs.
