...
Create a new spec using the {{command}} CLI. The user must provide a spec name as the argument.
...
Each instruction tells you to call `{{command}} spec goto --data '{"step":"{{next_step}}"}'` when the step is complete.